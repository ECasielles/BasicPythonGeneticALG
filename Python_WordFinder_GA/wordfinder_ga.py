...
class PopulationMap(object):
    ...
    #Constructor
    def __init__(self, target, stopcount,
    ...
    #TODO: Check matrices to save data instead of just showing it on screen

    #Matrix simulator
    def fillmap(self, target, stopcount,
                minpopulation, maxpopulation, minmutationrate, maxmutationrate):
    ...
    def run(self):
        ...
        self.fillmap(
            self.target, self.stopcount,
            self.minpopulation, self.maxpopulation, self.minmutationrate, self.maxmutationrate
            )
